...
import { getProjectById, getAllProjects, getRelatedProjects } from '@/lib/projects'
				...
				<section className="py-12 px-6">
					<div className="max-w-4xl mx-auto">
						<div className="relative h-96 w-full overflow-hidden rounded-lg border border-border bg-muted">
							<Image
								src={project.image || '/placeholder.svg?height=384&width=800&query=project showcase'}
								alt={project.name}
								fill
				...
				<section className="py-12 px-6 bg-card">
					<div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
						...
						<div className="border border-border rounded-lg p-6">
							...
							<p className="text-muted-foreground">{project.tech.join(', ')}</p>
						</div>
					</div>
					...
					<div className="border border-border rounded-lg p-8">
						...
						<p className="text-muted-foreground leading-relaxed text-lg mb-6">{project.fullDescription}</p>
							...
							<div className="grid grid-cols-1 md:grid-cols-3 gap-6">
								{relatedProjects.map((relatedProject) => (
									<Link
										...
										href={links.pages.project(relatedProject.id)}
