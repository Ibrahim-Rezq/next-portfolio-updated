...
function ProjectCard({ project }: { project: Project }) {
	const { id, image, name, github, liveDemo, description, tech, featured } = project
	...
	return (
		...
		>
			{featured && (
				<Badge variant="secondary" className="absolute right-4 top-4 z-10">
					<BadgeCheckIcon />
					Freatured
				</Badge>
			)}
			...
			<div className="p-6">
				<Link href={links.pages.project(project.id)} className="group/link">
